...
const FilePage = () => {
    ...
    const fetchFile = async () => {
      try {
        ...
        if (type.startsWith("text")) {
          ...
          const resp = await axios.get(data.signedUrl, { responseType: "arraybuffer" });
          const result = await mammoth.extractRawText({ arrayBuffer: resp.data });
  ...
  return (
    <div className="p-6 md:p-6">
      {folderPath && folderPath.length > 0 && <Breadcrumbs folders={folderPath} />}
